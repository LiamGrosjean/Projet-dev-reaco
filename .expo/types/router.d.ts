...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modals)/login` | `/login` | `/(modals)/menu` | `/menu` | `/(tabs)/` | `/(tabs)` | `/(tabs)/jobs` | `/jobs` | `/(tabs)/logements` | `/logements` | `/(tabs)/messagerie` | `/messagerie` | `/(tabs)/profil` | `/profil` | `/(tabs)/_layout` | `/_layout` | `/components/Head` | `/components/header` | `/components/quickaccess` | `/components/Search` | `/components/tile` | `/components/title`;
  // prettier-ignore
