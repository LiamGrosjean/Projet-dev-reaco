...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modals)/login` | `/login` | `/(modals)/menu` | `/menu` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/(tabs)/jobs` | `/jobs` | `/(tabs)/logements` | `/logements` | `/(tabs)/messagerie` | `/messagerie` | `/components/Search` | `/components/categorie` | `/components/cats` | `/components/header` | `/components/jobCard` | `/components/quickaccess` | `/components/tile` | `/components/title`;
  // prettier-ignore
